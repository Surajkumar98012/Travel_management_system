...
if(isset($_POST['done'])){
  ...
  $q="INSERT INTO `medicine`(`medicine_company`, `medicine_name`, `batch_no`, `mfg`, `exp`, `quantity`, `price_perunit`) VALUES (' $company',' $medname',' $batch',' $mfg',' $exp',' $quantity',' $price')";
  ...
  <div class="row">
    <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
              <h4>Add Medicine</h4>
              <p style="color: grey;margin-top: -10px;">Add New Medicine</p>
          </div>
        </div>
...
<br>
  <div style="background: white;margin: 20px;padding: 20px;margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);">
    <h4>Add Medicine</h4><hr>
     <form method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Medicine company: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="company" class="form-control" placeholder="Enter medicine company" required>

  </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Madicine Name <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="medname" class="form-control"  aria-describedby="emailHelp" placeholder="Enter medicine name" required>

  </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Medicine Batch No.: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="batch" class="form-control" placeholder="Enter Batch No." required>

  </div>

   <div class="form-group">
    <label for="exampleInputEmail1">MFG Date: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date" name="mfg" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="dd-mm-yy" required>
