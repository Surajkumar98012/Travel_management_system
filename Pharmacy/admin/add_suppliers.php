...
$r="INSERT INTO `suppliers`(`name`,`number`, `address`,`gender`) VALUES ('$name','$number','$address','$gender')";
  ...
  <div class="row">
    <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
              <h4>Add Suppliers</h4>
              <p style="color: grey;margin-top: -10px;">Add New Suppliers</p>
          </div>
        </div>
