    ...
    <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
              ...
              <p style="color: grey;margin-top: -10px;">Manage New Pharmacist</p>
          </div>
        </div>
...
include 'db_conn.php';
  ...
  $q="SELECT pharmacy_users.name,pharmacist.number,pharmacist.address,pharmacy_users.user_name FROM pharmacy_users,pharmacist WHERE pharmacy_users.user_name=pharmacist.user_name";
...
?>
 ...
 <tr>
    ...
    <td> <button type="submit" class="btn btn-primary"><a href="updatephar.php?username=<?php echo $res['user_name']; ?>" class="text-white">Update</a></button>
          <button type="submit" class="btn btn-danger"><a href="deletephar.php?username=<?php echo $res['user_name']; ?>"class="text-white"> Delete</a></button></td>
