    ...
    <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
              ...
              <p style="color: grey;margin-top: -10px;">Manage New Suppliers</p>
          </div>
        </div>
...
?>
 ...
 <tr>
    ...
    <td> <button type="submit" class="btn btn-primary"><a href="updatesup.php?id=<?php echo      $res['id']; ?>" class="text-white">Update</a></button>
          <button type="submit" class="btn btn-danger"><a href="deletesup.php?id=<?php echo $res['id']; ?>"class="text-white"> Delete</a></button></td>
