...
<html>
<head>
  <title>Pharmacist sold report</title>
 ...
 <!--  <a href="#services"><i class="fa fa-fw fa-wrench"></i> Services</a>
  ...
  <a class="dropdown-btn" href="#" ><i class="fa fa-fw fa-handshake-o"></i>&nbsp;&nbsp;Pharmacist
   ...
   <div class="dropdown-container">
    ...
    <a href="#">Pharmacist sold report</a>
   </div>
...
<br>
  <div style="background: white;margin: 20px;padding: 20px;margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);">
    <h4>Pharmacist Sold Report</h4><hr>
     <form action="" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">From Date: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date" name="from_date" class="form-control" placeholder="dd-mm-yy">

  </div>
    <div class="form-group">
    <label for="exampleInputEmail1">To Date: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date" name="to_date" class="form-control"  aria-describedby="emailHelp" placeholder="dd-mm-yy">

  </div>

<!--   <div class="form-group">
    <label for="exampleInputEmail1">Sold By Pharmacist <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Choose Pharmacist">
