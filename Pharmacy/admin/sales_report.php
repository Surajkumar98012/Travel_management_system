...
<!--     <div class="form-group">
  ...
  <label for="male">Month wise</label><br>
  <input type="radio" id="female" name="gender" value="female">
  <label for="female">Year wise</label>
  </div> -->
         ...
         foreach ($query as $res) {
           ?>
            <tr>
              ...
              <td>Rm <?php echo $res['price_perunit']; ?></td>
              <td>Rm <?php echo $res['quantity']*$res['price_perunit']; ?></td>
            </tr>
            <?php
         }
      }else{
