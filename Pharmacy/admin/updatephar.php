...
if(isset($_POST['done'])){
   ...
   $r="UPDATE `pharmacist` SET `address`='$address',`gender`='$gender',`number`='$number' WHERE user_name='$username'";
    ...
    <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
              ...
              <p style="color: grey;margin-top: -10px;">Update Pharmacist</p>
          </div>
        </div>
