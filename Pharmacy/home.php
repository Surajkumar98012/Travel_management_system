 ...
 <?php
           ...
           $q="SELECT COUNT(*) AS count FROM cart";
            ...
            $s="SELECT COUNT(*) AS count1 FROM pharmacy_users";
            ...
            $t="SELECT COUNT(*) AS count2 FROM suppliers";
...
<body>
  ...
  <h2 style="text-align: center;color: yellow;margin-top: 4px;font-size: 1.3em;"><?php echo $_SESSION['name'];?></h2>
   <a href="#home"><i class="fa fa-fw fa-tachometer" aria-hidden="true"></i>  &nbsp;Dashboard</a>
 <!--  <a href="#services"><i class="fa fa-fw fa-wrench"></i> Services</a>
  ...
  <a class="dropdown-btn" href="#" ><i class="fa fa-fw fa-handshake-o"></i>&nbsp;&nbsp;Pharmacist
   ...
   <div class="dropdown-container">
    <a href="admin/add_pharmacist.php">Add Pharmacist</a>
    <a href="admin/manage_pharmacist.php">Manage Pharmacist</a>
   ...
   <div class="dropdown-container">
  <!--   <a href="admin/medicine_company.php">Medicine Company</a> -->
    <a href="admin/add_medicine.php">Add Medicine</a>
    <a href="admin/manage_medicine.php">Manage Medicine</a>
   </div>
   ...
   <div class="dropdown-container">
    <a href="admin/add_suppliers.php">Add Suppliers</a>
    <a href="admin/manage_suppliers.php">Manage Suppliers</a>
   </div>
   ...
   <div class="dropdown-container">
    <a href="admin/stock_report.php">Stock Report</a>
   </div>
   ...
   <div class="dropdown-container">
    <a href="admin/sales_report.php">Sales Report</a>
    <a href="admin/pharmacistsold_report.php">Pharmacist sold report</a>
   </div>


   <a id="logout" style="margin-top:164px;" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>  &nbsp;Logout</a>
...
<div id="main">
  <span style="font-size:31px;cursor:pointer; padding-left: 16px;color: indigo;" onclick="openNav()">&#9776;&nbsp;&nbsp;Dashboard <p style="float: right;color: black;font-size:0.7em;margin-top: 8px;"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;&nbsp;Home</p></span>
  ...
  <div class="counter-up">
    <div class="content">
      <div class="box">
        ...
        <div class="counter"><?php echo $output1;?></div>
        <div style="font-size:1.21em;" class="text">Total Pharmacist</div>
      ...
      <div class="box">
        ...
        <div class="counter"><?php echo $output2;?></div>
        <div class="text">Total Suppliers</div>
  ...
  <div class="row">
    ...
    <i style="font-size:4em;" class="fa fa-medkit color"></i>
     ...
     <h4 style="color: black;font-weight: bolder;margin-top: 21px;">Add Medicine</h4>
      ...
      <div class="col-md-3 boxes" >
         <a  href="./admin/add_pharmacist.php">
     <i  style="font-size:4em;"  class="fa  fa-handshake-o color"></i>
     <h4 style="color: black;font-weight: bolder;margin-top: 21px">Add Pharmacist</h4>
    </a>
    </div>
      <div class="col-md-3 boxes">
         <a  href="./admin/add_suppliers.php">
     <i  style="font-size:4em;"  class="fa fa-user color"></i>
     <h4 style="color: black;font-weight: bolder;margin-top: 21px">Add suppliers</h4>
</a>
    </div>
  </div>
   ...
   <div class="row" style="margin-top: -45px;">
    ...
    <i style="font-size:4em;" class="fa fa-file-text-o color"></i>
     ...
     <h4 style="color:  black;font-weight: bolder;margin-top: 21px">Sales report</h4>
      ...
      <div class="col-md-3 boxes" >
      <a  href="./admin/stock_report.php">
     <i  style="font-size:4em;"  class="fa  fa-file color"></i>
     <h4 style="color: black;font-weight: bolder;margin-top: 21px">Stock report</h4>
    </a>
    </div>
      <div class="col-md-3 boxes">
         <a  href="./admin/pharmacistsold_report.php">
     <i  style="font-size:4em;"  class="fa fa-file-text color"></i>
     <h4 style="color:  black;font-weight: bolder;margin-top: 21px">Pharmacist sold Report</h4>
     </a>
    </div>
  </div>
</div>
