...
<br>
    <div class="container-fluid">
            <form action="search.php" class="form" method="post">
                <input type="text" class="search" placeholder="Search  Medicine" name="search" size="80">
...
<br>
  ...
  <br>
    ...
    <h4>Medicine Search Result !</h4><hr>
...
if (isset($_POST['search'])){
  ...
  $q="SELECT * FROM medicine WHERE medicine_name LIKE '%$searchq%'";
