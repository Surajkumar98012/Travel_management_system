...
if(isset($_POST['done'])){
  ...
  $q="INSERT INTO `bus`(`name`, `src`, `dst`, `dates`, `feature`, `time`,`atime`, `duration`, `price`) VALUES ('$name','$from','$to','$date','$feature','$time','$atime','$duration','$price')";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">PLEASE ADD BUS DETAILS</h3>
