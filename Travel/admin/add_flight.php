...
if(isset($_POST['done'])){
  ...
  $q="INSERT INTO `flight`(`name`, `src`, `dst`, `dates`, `trip`, `time`,`atime`, `duration`, `price`) VALUES ('$name','$from','$to','$date','$trip','$time','$atime','$duration','$price')";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">PLEASE ADD FLIGHT DETAILS</h3>
