...
if(isset($_POST['done']) && isset($_FILES['img'])){
  ...
  $q="INSERT INTO `hotel`(`hotel_name`, `beds`, `location`, `type`, `price`, `image`) VALUES (' $hotel',' $beds', '$location', '$type','$price','$new_img_name')";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">PLEASE ADD HOTELS DETAILS</h3>
