  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">MANAGE YOUR BUSES HERE..</h3>
...
?>
  <tr>
    ...
    <td> <button type="submit" class="btn btn-primary"><a href="update_bus.php?id=<?php echo      $res['id']; ?>" class="text-white">Update</a></button>
          <button type="submit" class="btn btn-danger"><a href="delete_bus.php?id=<?php echo $res['id']; ?>"class="text-white"> Delete</a></button></td>
