  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">MANAGE YOUR FLIGHT HERE..</h3>
...
?>
  <tr>
    ...
    <td><?php echo $res['dst']; ?></td>
     <td><?php echo $res['dates']; ?></td>
     <td><?php echo $res['trip']; ?></td>
     <td><?php echo $res['time']; ?></td>
     <td><?php echo $res['atime']; ?></td>
     <td><?php echo $res['duration']; ?></td>
     <td><?php echo $res['price']; ?></td>
    <td> <button type="submit" class="btn btn-primary"><a href="update_flight.php?id=<?php echo      $res['id']; ?>" class="text-white">Update</a></button>
          <button type="submit" class="btn btn-danger"><a href="delete_flight.php?id=<?php echo $res['id']; ?>"class="text-white"> Delete</a></button></td>
