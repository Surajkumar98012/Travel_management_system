...
if(isset($_POST['done'])){
  ...
  $q="UPDATE `bus` SET `id`=$id,`name`='$name',`src`='$from',`dst`='$to',`dates`='$date',`feature`='$feature',`time`='$time',`atime`='$atime',`duration`='$duration',`price`='$price' WHERE id=$id";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">PLEASE UPDATE BUS DETAILS</h3>
...
<br>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Bus Name: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="name" class="form-control" placeholder="Enter Bus name" required>

  </div>


    <div class="form-group">
    <label for="exampleInputEmail1">From: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="from" class="form-control" placeholder="Enter Source" required>

  </div>


     <div class="form-group">
    <label for="exampleInputEmail1">To: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="to" class="form-control" placeholder="Enter Destination" required>

  </div>


     <div class="form-group">
    <label for="exampleInputEmail1">Departure Date: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date" name="date" class="form-control" placeholder="Enter Departure Date" required>
   ...
   <div class="form-group">
  <p>Features: <span style="color: red;font-weight: bold;">*</span></p>
  <input type="radio" id="A/C-sleeper" name="feature" value="A/C-sleeper" required>
  <label for="A/C-sleeper">A/C-sleeper</label><br>
  <input type="radio" id="Non-A/C-sleeper" name="feature" value="Non-A/C-sleeper">
  <label for="Non-A/C-sleeper">Non-A/C-sleeper</label><br>
  </div>


    <div class="form-group">
    <label for="exampleInputEmail1">Departure Time: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="time" name="time" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Departure Time" required>

  </div>

      <div class="form-group">
    <label for="exampleInputEmail1">Arrival Time: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="time" name="atime" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Arrival Time" required>

  </div>

    <div class="form-group">
    <label for="exampleInputEmail1">Duration: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="duration" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Duration" required>
