...
if(isset($_POST['done'])){
  ...
  $q="UPDATE `car` SET `id`=$id,`name`='$name',`src`='$from',`dst`='$to',`dates`='$date',`feature`='$feature',`seats`='$seats',`price`='$price' WHERE id=$id";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">PLEASE UPDATE CAR DETAILS</h3>
...
<br>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Car Name: <span style="color: red;font-weight: bold;">*</span></label>
    ...
    <input type="text" name="from" class="form-control" placeholder="Enter Pick-up location" required>
    ...
    <input type="text" name="to" class="form-control" placeholder="Enter Drop Location" required>
  ...
  <input type="radio" id="A/C" name="feature" value="A/C" required>
  <label for="A/C">A/C</label><br>
  <input type="radio" id="Non-A/C" name="feature" value="Non-A/C">
  <label for="Non-A/C">Non-A/C</label><br>
  </div>


    <div class="form-group">
    <label for="exampleInputEmail1">Seats: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="seats" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Number of seats" required>
