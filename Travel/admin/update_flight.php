...
if(isset($_POST['done'])){
  ...
  $q="UPDATE `flight` SET `id`=$id,`name`='$name',`src`='$from',`dst`='$to',`dates`='$date',`trip`='$trip',`time`='$time',`atime`='$atime',`duration`='$duration',`price`='$price' WHERE id=$id";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">PLEASE UPDATE FLIGHT DETAILS...</h3>
...
<br>
  ...
  <div style="background: white;margin: 20px;padding: 20px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius:8px;">
    <h4>Update Flight</h4><hr>
     <form method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1">Flight Name: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="name" class="form-control" placeholder="Enter Flight name" required>
   ...
   <div class="form-group">
  <p>Trip: <span style="color: red;font-weight: bold;">*</span></p>
  <input type="radio" id="One-way" name="trip" value="One-way" required>
