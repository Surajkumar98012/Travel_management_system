...
if(isset($_POST['done']) && isset($_FILES['img'])){
  ...
  if($error===0){
    if ($img_size>1250000) {
       ...
       header("Location:add_hotel.php?error=$em");
    }else{
      $img_ex=pathinfo($img_name,PATHINFO_EXTENSION);
       $img_ex_lc=strtolower($img_ex);

       $allowed_exs=array("jpg","jpeg","png","svg","gif");
  ...
  $q="UPDATE `hotel` SET `id`=$id,`hotel_name`='$hotel',`beds`='$beds',`location`='$location',`type`='$type',`price`='$price',`image`='$new_img_name' WHERE id=$id";
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">UPDATE YOUR HOTELS DETAILS...</h3>
...
<br>
    ...
    <p style="font-size:1.5em;text-align: center;color: red;"><?php echo $_GET['error'] ?></p>
    <?php endif ?>
  <div style="background: white;margin: 20px;padding: 20px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius:8px;">
    <h4>Update Hotel</h4><hr>
     <form method="post" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1">Hotel Name: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="hotel" class="form-control" placeholder="Enter Hotel name" required>

  </div>
   <div class="form-group">
  <p>Beds <span style="color: red;font-weight: bold;">*</span></p>
  <input type="radio" id="double-bed" name="beds" value="double-bed" required>
  <label for="double">Double Bed</label><br>
  <input type="radio" id="single-bed" name="beds" value="single-bed">
  <label for="single">Single Bed</label><br>
  </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Location: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="location" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Location" required>

  </div>

  <div class="form-group">
  <p>Type <span style="color: red;font-weight: bold;">*</span></p>
  <input type="radio" id="couple-friendly" name="type" value="couple-friendly" required>
  <label for="couple">Couple Friendly</label><br>
  <input type="radio" id="not-couple-friendly" name="type" value="not-couple-friendly">
  <label for="notcouple">Not Couple Friendly</label><br>
  ...
  <label for="family">Family</label>
   ...
   <div class="form-group">
    <label for="exampleInputEmail1">Add Image: <span style="color: red;font-weight: bold;">*</span></label>
