  ...
  if (empty($username)) {
    header("Location: index.php?error=User Name is required&$user_data");
      ...
      exit();
        ...
        header("Location: index.php?error=Confirm Password is required&$user_data");
      exit();
  }
    ...
    if (mysqli_num_rows($result) > 0) {
      header("Location: index.php?error=The username is taken try another&$user_data");
          exit();
           ...
           $sql2 = "INSERT INTO users(user_name, password, name,mobile) VALUES('$username', '$password', '$name','$mobile')";
