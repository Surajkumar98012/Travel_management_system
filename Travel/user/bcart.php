...
?>
      ...
      <div class="container" style="background:white;padding:15px; margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius: 7px;margin-top:10px;">
        <div class="row">
          <div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;padding-top:32px;margin-left: 90px;">
            <i class="fa fa-bus icn" aria-hidden="true"></i>
            <p style="margin-left:5px;font-size:1.15em;font-weight: bolder;"><?php echo $res['name']; ?></p>
          </div>

          <div class="col-md-2" style="padding-top:20px;">
            <h5><?php echo $res['time']; ?></h5>
            <p><?php echo $res['src']; ?></p>

          </div>

          <div class="col-md-2">
            <p><?php echo $res['duration']; ?></p>
            <hr style="border-top: 3px solid red;">
            <p><?php echo $res['feature']; ?></p>
          </div>

         <div class="col-md-2"  style="padding-top:20px;">
            <h5><?php echo $res['atime']; ?></h5>
            <p><?php echo $res['dst']; ?></p>

          </div>

          <div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;">
           <h5 style="padding-top: 30px;font-weight: bolder;">RM <?php echo $res['price']; ?></h5>
          </div>
