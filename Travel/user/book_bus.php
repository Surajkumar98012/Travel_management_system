  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">BOOK YOUR BUSES HERE..</h3>
...
if (isset($_POST['search']) && isset($_POST['searchd']) && isset($_POST['from_date'])){
  ...
  $q="SELECT * FROM bus WHERE  src LIKE '%$searchq%'  AND dst LIKE '%$searchr%' AND dates LIKE '%$from_date%'";
...
?>
      ...
      <div class="container-fluid" style="background:white;padding:15px; margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius: 7px;margin-top:10px;">
        <div class="row">
          <div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;padding-top:30px;">
         ...
         <div class="col-md-2" style="padding-top:15px;">
          ...
          <div class="col-md-2" style="padding-top:30px;">
           <a style="color:black;background:green;padding: 8px 8px;border-radius: 5px;text-decoration:none;"href="bcart.php?id=<?php echo $res['id']; ?>"class="text-white">Book Now</a>
          </div>
        </div>
      </div>
