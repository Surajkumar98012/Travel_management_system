  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">BOOK YOUR FLIGHTS HERE..</h3>
...
<br>
  ...
  <br>
    ...
    <div style="background:rgb(230,230, 230);margin: 20px;padding: 20px;margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius: 7px;margin-top: 40px;">
    <h4>Book Flights</h4><hr>
  <form  method="post">
  <div class="form-group">

    <label for="">From ?: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="search" class="form-control" placeholder="Enter source">

  </div>
    <div class="form-group">
    <label for="">To ?: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="searchd"  class="form-control"  aria-describedby="emailHelp" placeholder="Enter Destination">



  </div>
  <div class="form-group">
     <label for="">Depart: <span style="color: red;font-weight: bold;">*</span></label>
      <input class="form-control" type="date"  placeholder="Enter Departure Date" name="from_date">
  </div>

   <button type="submit" name="submit" style="background:blue;color: white;margin-left: -2px;" class="btn">Search</button>
</form>
...
if (isset($_POST['search']) && isset($_POST['searchd']) && isset($_POST['from_date'])){
   $from_date= $_POST['from_date'];
  $searchq=$_POST['search'];
  $searchr=$_POST['searchd'];
  /*$searchq=preq_replace("#[^0-9a-z]#i","",$searchq);*/
  $q="SELECT * FROM flight WHERE  src LIKE '%$searchq%'  AND dst LIKE '%$searchr%' AND dates LIKE '%$from_date%'";
...
?>
      ...
      <div class="container-fluid" style="background:white;padding:15px; margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius: 7px;margin-top:10px;">
        <div class="row">
          <div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;padding-top:15px;">
         ...
         <div class="col-md-2">
          ...
          <div class="col-md-2" style="padding-top:20px;">
           <a style="color:white;background:green;padding: 8px 8px;border-radius: 5px;text-decoration:none;"href="tcart.php?id=<?php echo $res['id']; ?>"class="text-white">Book Now</a>
          </div>
        </div>
      </div>
