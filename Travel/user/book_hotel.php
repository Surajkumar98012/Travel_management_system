  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">BOOK YOUR HOTELS HERE..</h3>
...
<br>
  ...
  <div class="form-group">
    <input class="form-control" type="text"  placeholder="Enter Location" name="search"><br>
    <label for="">Check in: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date"  class="form-control" placeholder="dd-mm-yy">

  </div>
    <div class="form-group">
    <label for="">Check out: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date"  class="form-control"  aria-describedby="emailHelp" placeholder="dd-mm-yy">
...
if (isset($_POST['search'])){
  ...
  $q="SELECT * FROM hotel WHERE location LIKE '%$searchq%'";
...
?>
      ...
      <p style="color:red;"><i class="fa fa-users icn" aria-hidden="true"></i><?php echo $res['type']; ?></p>
      <p style="font-size:1.05em;font-weight:bold;color:rgba(0, 0, 0, 0.7);margin-left: 5px;">RM <?php echo $res['price']; ?></p>
