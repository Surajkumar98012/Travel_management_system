...
// hashing the cvv
  ...
  $r="INSERT INTO `cart`( `name`, `location`, `exp`,`email`,  `price`,`cname`, `cnumber`, `cvv`,`id`) VALUES ('$name','$location','$date','$email','$price','$cname','$cnumber','$cvv',(SELECT id from users where id='".$_SESSION['id']."'))";
/*}*/
  ...
  <div class="container" id="mains">
   <div class="row" style="padding-top: 95px;">
     <div class="col-md-6" style="padding: 26px;background-color: rgba(0, 0, 0, 0.7);border-radius: 25px;" >
       ...
       <h3 style="margin-top:20px;color: white;font-size: 1.5em;">BOOK YOUR PACKAGE HERE..</h3>
...
?>
      ...
      <img  src="../admin/upload/<?php echo $res['image']?>">
      <p style="font-size:1.3em;font-weight:bolder;margin-top: 5px;justify-content: center;"><?php echo $res['hotel_name']; ?></p>

      <p style="color:blue;"><i class="fa fa-map-marker icn" aria-hidden="true"></i><?php echo $res['location']; ?></p>

      <p style="color:brown;"><i class="fa fa-bed icn" aria-hidden="true"></i><?php echo $res['beds']; ?></p>

      <p style="color:green;"><i class="fa fa-user-md icn" aria-hidden="true"></i>Doctor on call</p>

      <p style="color:red;"><i class="fa fa-users icn" aria-hidden="true"></i>Type :<?php echo $res['type']; ?></p>
      <p style="font-size:1.05em;font-weight:bold;color:rgba(0, 0, 0, 0.7);margin-left: 5px;">Amount : RM <?php echo $res['price']; ?></p>
      <!-- <a style="color:white;background:blue;padding: 7px 7px;margin-right:165px ;border-radius: 5px;text-decoration:none;"href="cart.php?id=<?php echo $res['id']; ?>"class="text-white">Book Now</a> -->
...
<div class="container-fluid"  style="background:rgba(215,215,215,0.9);">
  <div style="background: white;margin: 20px;padding: 20px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius:8px;">
      <h4>Make Payment</h4><hr>

  <form method="POST" enctype="multipart/form-data">
  <div class="form-group">
    <label for="exampleInputEmail1">Package Name: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="name" class="form-control" placeholder="Enter Package Name" required>
    <label for="exampleInputEmail1">Location: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="location" class="form-control" placeholder="Enter Location" required>
    <label for="exampleInputEmail1">Email: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="email" class="form-control" placeholder="Enter Email" required>

     <label for="exampleInputEmail1">Price: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="price" class="form-control" placeholder="Enter Total amount" required>

     <label for="exampleInputEmail1">Card Number: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="cnumber" class="form-control" placeholder="Enter Card No." required>

    <label for="exampleInputEmail1">Name on Card: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="cname" class="form-control" placeholder="Enter Name" required>

    <label for="exampleInputEmail1">Expiry Date: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="date" name="date" class="form-control" placeholder="Enter expiry date." required>

    <label for="exampleInputEmail1">CVV: <span style="color: red;font-weight: bold;">*</span></label>
    <input type="text" name="cvv" class="form-control" placeholder="Enter CVV." required>
<br>

      <button type="submit" name="done" class="btn btn-success">Make Payment</button>
  </div>
