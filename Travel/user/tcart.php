...
?>
      ...
      <div class="container" style="background:white;padding:15px; margin-top: -1px;box-shadow: 0 15px 25px rgba(0,0,0,0.5);border-radius: 7px;margin-top:10px;">
        <div class="row">
          <div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;padding-top:15px;margin-left: 90px;">
            <i class="fa fa-plane icn" aria-hidden="true"></i>
            <p style="margin-left:10px;font-size:1.15em;font-weight: bolder;"><?php echo $res['name']; ?></p>
          </div>
         ...
         <div class="col-md-2">
          ...
          <div class="col-md-2" style="display: flex;flex-direction: row;justify-content: center;">
           <h5 style="padding-top: 20px;font-weight: bolder;">RM <?php echo $res['price']; ?></h5>
          </div>
